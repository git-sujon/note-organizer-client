      ...
      <form onSubmit={handleSubmit(onSubmit)}>
        <div className="">
          <div className=" md:px-5 lg:px-20 mt-10">
            <h1 className="text-center text-2xl lg:text-4xl font-bold text-slate-900">
              Add A Note
            </h1>
            <div className="space-y-4 mt-10">
              ...
              <div>
                ...
                <textarea
                  ...
                  className="w-3/5 p-4 text-gray-600 bg-indigo-50 outline-none rounded-md"
                  {...register("notesDetails", { required: "Description is required" })}
                ></textarea>
                     <p className="text-red-500">
              ...
              <button className=" px-6 py-1  block rounded-md text-lg font-semibold text-indigo-50 bg-slate-900  ">
                ADD
              </button>
            </div>
          </div>
